...
All implementation work must be traceable to an issue or task specification, performed on a branch, reviewed through a pull request, and checked against acceptance criteria.
